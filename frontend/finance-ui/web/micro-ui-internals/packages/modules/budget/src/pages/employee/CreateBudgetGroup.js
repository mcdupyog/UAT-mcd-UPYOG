      ...
      <Card>
        <div style={{ marginBottom: "16px" }}>
          <div style={{ padding: "16px", marginTop: "8px" }}>
            ...
            <div style={{ marginBottom: "24px" }}></div>
            {selectedRadioButton?.code === "YES" && (
            <LabelFieldPair>
              <CardLabel>{`${t("FINANCE_MAJOR_CODE")}`}</CardLabel>
              <div className="field">
                <Controller
                  control={control}
                  name={"useMajorCode"}
                  ...
                  render={(props) => (
                    <Dropdown className="form-field"
                      ...
                      optionKey="i18nKey"
                      t={t}
                      placeholder ={"Type first 3 letters of Account"} />
                  )}
                />
              </div>
            </LabelFieldPair>
            )}
            {selectedRadioButton?.code == "NO" && (
              <React.Fragment>
                <LabelFieldPair>
                  <CardLabel>{`${t("FINANCE_RANGE_START")}`}</CardLabel>
                  <div className="field">
                    <Controller
                      control={control}
                ...
                <div style={{ marginBottom: "24px" }}></div>
                <LabelFieldPair>
                  <CardLabel>{`${t("FINANCE_RANGE_END")}`}</CardLabel>
                  <div className="field">
                    <Controller
                      control={control}
                      name={"detailedMinCode"}
