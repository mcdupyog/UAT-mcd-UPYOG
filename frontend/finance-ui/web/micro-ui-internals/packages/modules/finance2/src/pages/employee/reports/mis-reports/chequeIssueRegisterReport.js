...
import ChequeIssueFilterForm from "../../../../components/reports/ChequeIssueFilterForm";
import ChequeIssueReportTable from "../../../../components/reports/ChequeIssueReportTable";
const ChequeIssueRegisterPage = () => {
  ...
  return (
    <div style={{ padding: "16px" }}>
      ...
      >
        <div>
          <h1>📊Cheque Issue Register Report</h1>
        </div>
      </Card>
      
      <ChequeIssueFilterForm 
...
export default ChequeIssueRegisterPage;