...
const SurrenderedCheque = () => {
  ...
  return (
    <div style={{ padding: "16px" }}>
      ...
      >
        <div>
          <h1>📊Surrendered Cheque Report</h1>
        </div>
      </Card>
      
      <SurrenderedChequeForm
...
export default SurrenderedCheque;